  ...
  (function (Module) {
    ...
    Module["instantiateWasm"] = function callee(imports, onSuccess) {
      ...
      const loadWasm = async () => {
        ...
        return WebAssembly.instantiate(decompressed, imports).then((arg) => {
          arg.imports = imports;
  ...
  Module.runSQLite3PostLoadInit = function (
    ...
    globalThis.sqlite3ApiBootstrap = async function sqlite3ApiBootstrap(
...

      {
        ...
        wasm.alloc = function f(n) {
          return (
            f.impl(n) || WasmAllocError.toss("Failed to allocate", n, " bytes.")
          );
        };
    ...
    globalThis.WhWasmUtilInstaller = function (target) {
      ...
      target.jstrcpy = function (
        ...
        for (; i < max && offset < end; ++i) {
          ...
          if (u >= 0xd800 && u <= 0xdfff) {
            u =
              (0x10000 + ((u & 0x3ff) << 10)) | (jstr.charCodeAt(++i) & 0x3ff);
          }
          if (u <= 0x7f) {
            if (offset >= end) break;
            tgt[offset++] = u;
      ...
      const finalThen = function (arg) {
        if (config.wasmUtilTarget) {
          ...
          if (!tgt.instance.exports.memory) {
            tgt.memory =
              config?.imports?.env?.memory || toss("Missing 'memory' object!");
          }
    ...
    globalThis.Jaccwabyt = function StructBinderFactory(config) {
      ...
      const heap = __heap ? __heap : () => new Uint8Array(__heap.buffer),
        ...
        ptrIR = config.pointerIR || config.ptrIR || "i32",
        ptrSize = config.ptrSize || ("i32" === ptrIR ? 4 : 8);
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
...

      {
        ...
        util.sqlite3__wasm_db_error = function (pDb, resultCode, message) {
          ...
          return (
            capi.sqlite3_set_errmsg(pDb, resultCode, message) || resultCode
          );
        };
      }
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      DB.prototype = {
        ...
        createFunction: function f(name, xFunc, opt) {
          ...
          const pApp = opt.pApp;
          if (undefined !== pApp && null !== pApp && !wasm.isPtr(pApp)) {
            toss3(
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      vtab.xError.errorReporter = 1
        ? sqlite3.config.error.bind(sqlite3.config)
        : false;
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      const installOpfsVfs = function callee(options) {
        ...
        const thePromise = new Promise(function (
          ...
          let W;
          try {
            W = new Worker(new URL(options.proxyUri, import.meta.url));
          } catch (e) {
            promiseReject(e);
            return;
          }
          ...
          if (!opfsVfs.$xRandomness) {
            vfsSyncWrappers.xRandomness = function (pVfs, nOut, pOut) {
              ...
              for (; i < nOut; ++i)
                heap[npOut + i] = (Math.random() * 255000) & 0xff;
              return i;
            };
          }
          if (!opfsVfs.$xSleep) {
    ...
    globalThis.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
      ...
      class OpfsSAHPool {
        ...
        getPath(arg) {
          ...
          return (arg instanceof URL ? arg : new URL(arg, "file://localhost/"))
            .pathname;
        }
    ...
    if ("undefined" === typeof EmscriptenModule) {
      ...
      throw new Error(
        "sqlite3-api-cleanup.js expects to be running in the " +
