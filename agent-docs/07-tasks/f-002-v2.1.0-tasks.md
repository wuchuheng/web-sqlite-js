...
- [ ] Global namespace type: `Record<string, {migrationSQL: Map<string, string>, seedSQL: Map<string, string>, db: DBInterface}>`
...
- [ ] T-002: In-Memory SQL & Global Namespace (Pending)
- [ ] T-003: Auto-Migration System (Pending)
- [x] All acceptance criteria met (for T-001)
